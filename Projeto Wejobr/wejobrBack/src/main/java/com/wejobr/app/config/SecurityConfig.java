...
//
//import com.wejobr.app.services.UserService;
//
//@Configuration
//@EnableWebSecurity
...
//	 .antMatchers("/vagas/admin/**").hasRole("ADMIN")
//	 .antMatchers("/vagas/**").hasRole("USER")
//	 .antMatchers("/empresas/admin/**").hasRole("ADMIN")
//	 .antMatchers("/empresas/**").hasRole("USER")
//	 .antMatchers("/candidatos/**").hasRole("ADMIN")
//	 .antMatchers("/recrutadores/**").hasRole("ADMIN")
//	 .anyRequest().authenticated().and() .formLogin().and().httpBasic(); }
//	 
//	 
//	 
//	 //Para uso sem configurações de segurança
//
///*	@Override
//	protected void configure(HttpSecurity http) throws Exception {
